...
struct DummyData {
    ...
    static let characters = [
        Character(uuid: UUID(uuidString: "6E4371D8-47B5-403A-AEA2-64D5D3C899AD") ?? UUID.init(),
                  ...
                  allegiances: [organizations[0].uuid],
                  relationships: [],
                  ethnicity: "Leprecaun",
        ...
        Character(uuid: UUID(uuidString: "89D086D0-930E-4D12-91BC-EE46D30182C9") ?? UUID.init(),
                  ...
                  allegiances: [organizations[0].uuid, organizations[1].uuid],
                  relationships: [],
        ...
        Character(uuid: UUID(uuidString: "268499CA-4A27-4889-9098-314A36AEE483") ?? UUID.init(),
                  ...
                  allegiances: [organizations[2].uuid],
                  relationships: [],
                  ethnicity: "Main Character",
                  flaws: ["Unintelligent"],
    ...
    static let relationships = [
        Relationship(uuid: UUID(uuidString: "568499CA-4A27-4889-9098-314A36AEE484") ?? UUID.init(), participats: [characters[0].uuid, characters[2].uuid], relationshipImportance: .important, type: .ally),
        
        Relationship(uuid: UUID(uuidString: "668499CA-4A27-4889-9098-314A36AEE485") ?? UUID.init(), participats: [characters[2].uuid, characters[1].uuid], relationshipImportance: .somewhatImportant, type: .enemy),
        
        Relationship(uuid: UUID(uuidString: "768499CA-4A27-4889-9098-314A36AEE486") ?? UUID.init(), participats: [characters[0].uuid, characters[1].uuid], relationshipImportance: .important, type: .enemy)
    ]
    ...
    static let places = [
        Place(uuid: UUID(uuidString: "7CD0F95C-2685-47B4-A3DB-949AB8B4A5FE") ?? UUID.init(), name: "Hogwarts", appearsInChapter: [chapters[0].uuid, chapters[1].uuid]),
        Place(uuid: UUID(uuidString: "CF49755F-1CD1-4D2D-9183-2098C5356ECF") ?? UUID.init(), name: "Magnolia", appearsInChapter: [chapters[0].uuid, chapters[2].uuid]),
        Place(uuid: UUID(uuidString: "E20EB299-DB31-4D64-95DE-84E823087182") ?? UUID.init(), name: "Hidden Leaf Village", appearsInChapter: [chapters[1].uuid])
    ]
